...
LIBS = \
	$(LIB_DIR)/liblinear_elastic_with_vertical_tens_cutoff.so \
	$(LIB_DIR)/libmatsuoka_nakai.so
...
# Shared libraries
$(LIB_DIR)/liblinear_elastic_with_vertical_tens_cutoff.so: $(COMMON_OBJS) $(BUILD_DIR)/linear_elastic_with_vertical_tens_cutoff.o
	$(CC) $(LDFLAGS) -o $@ $^

$(LIB_DIR)/libmatsuoka_nakai.so: $(COMMON_OBJS) $(BUILD_DIR)/matsuoka_nakai_surface.o $(BUILD_DIR)/matsuoka_nakai.o
	$(CC) $(LDFLAGS) -o $@ $^
