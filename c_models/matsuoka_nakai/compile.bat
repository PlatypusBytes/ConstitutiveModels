...
cl /c /EHsc /W3 matsuoka_nakai.c ../utils.c ../stress_utils.c ../yield_surfaces/matsuoka_nakai_surface.c
link /DLL /OUT:matsuoka_nakai.dll matsuoka_nakai.obj utils.obj stress_utils.obj matsuoka_nakai_surface.obj /DEF:umat.def