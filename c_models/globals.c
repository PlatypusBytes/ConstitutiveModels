...
const int YY = 1; // Y component
const int ZZ = 2; // Z component
const int XY = 3; // XY shear component
const int YZ = 4; // YZ shear component
const int XZ = 5; // XZ shear component
